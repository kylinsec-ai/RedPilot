...
Deploy the GOAD NHA (Ninja Hacker Academy) lab on Ludus. NHA is a training challenge where you must find your way to domain admin on 2 domains.

**Props:** Huge shout out to [@M4yFly](https://twitter.com/M4yFly) for all the hard work to create GOAD NHA!
