...
def render_heimdall_payload(code: str) -> dict:
    ...
    try:
        from redpilot.worker.adapter.heimdall import load_state, render, _KEEP_PER_KIND
        from redpilot.worker.adapter.compliance import flag_plaintext_rx, scrub_text, count_redactions
