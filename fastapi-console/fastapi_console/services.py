...
def render_heimdall_payload(code: str) -> dict:
    ...
    try:
        from redpilot_worker.adapter.heimdall import load_state, render, _KEEP_PER_KIND
        from redpilot_worker.adapter.compliance import flag_plaintext_rx, scrub_text, count_redactions
