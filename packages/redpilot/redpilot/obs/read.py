...
from redpilot_contracts.assets import ASSET_RX as _ASSET_RX
from redpilot_contracts.assets import ASSET_TYPES as _ASSET_TYPES
from redpilot_contracts.digest import fold_rows
from redpilot_contracts.vocabulary import SSE_HEARTBEAT_S, SNAPSHOT_KIND, strip_out_of_band
...
# mime 表与穿越守卫单源于 redpilot_contracts.assets(与 worker 侧仪表板共用);
...
async def status(request: Request) -> dict:
    ...
    出口剥掉 `_` 前缀带外键:redpilot_contracts.vocabulary 规定这些键(如 `_accepted_flags`
