...
模块职责:
  ...
  obs/schema.py    pydantic 摄取模型 + 词汇 re-export(单源 redpilot_contracts)
...
共享语义(词汇/快照/脱敏/截断/原子 IO/折叠状态机/资产表)单源 redpilot_contracts;
本包绝不 import redpilot_worker(纯度测试强制)。
"""
