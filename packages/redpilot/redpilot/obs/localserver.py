...
import redpilot_worker,worker 的 driver 负责装配)。
...
redpilot_contracts —— :8080 与 :8090 的字节兼容由测试强制而非注释约定。
...
from redpilot_contracts.assets import ASSET_RX, ASSET_TYPES
from redpilot_contracts.paths import (FLAG_FILES, FLAG_MAX_LINES,
                                       LIVE_DIR, TRANSCRIPT_FILENAME, safe_code)
from redpilot_contracts.vocabulary import ACTIVE_PHASES, SNAPSHOT_KIND, \
