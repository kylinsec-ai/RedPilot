...
from redpilot_contracts.platform import EventEnvelope, new_id
...
class Store:
    ...
    def _reap_expired_leases_locked(self, connection, now: float) -> list[str]:
        ...
        (redpilot_contracts.CANONICAL_TERMINAL_STATUSES),不发则 obs 侧 run 永挂 running。
    ...
    def _terminate_attempt_locked(
        ...
        *,
        ...
        attempts.status,绕过了事件写入。而 redpilot_contracts.CANONICAL_TERMINAL_STATUSES
