...
契约:redpilot_contracts.CANONICAL_TERMINAL_STATUSES 含 `interrupted`,即**所有**终态
...
from redpilot.control.provisioner import ProvisionedContainer
...
def test_seed_does_not_apply_flag_changes_but_reports_drift(tmp_path, caplog):
    ...
    with caplog.at_level(logging.ERROR, logger="redpilot.control.service"):
