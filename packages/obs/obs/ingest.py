...
from .canonical_ingest import post_canonical_events  # noqa: F401 (兼容导出)
from .canonical_ingest import router as canonical_router
from .telemetry_ingest import (  # noqa: F401 (兼容导出)
    post_events,
    post_live,
    post_ping,
    post_roster,
...
from .telemetry_ingest import router as telemetry_router
