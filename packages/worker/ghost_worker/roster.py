...
from ghost_contracts.fsio import atomic_write_json
from ghost_contracts.paths import LIVE_DIR, ROSTER_FILENAME

from ghost.obs.localserver import (challenge_detail, empty_roster_snapshot,
                             local_challenge_row, read_flag_lines, scan_local)

log = logging.getLogger("ghost_worker.roster")
