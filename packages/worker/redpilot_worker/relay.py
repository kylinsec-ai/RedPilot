...
from redpilot_contracts.paths import FLAG_MAX_LINES
from redpilot_contracts.vocabulary import (MESSAGE_UPDATE, PHASES,
                                            RUN_CLOSE_STATUSES, strip_for_snapshot)

log = logging.getLogger("redpilot_worker.relay")
...
class ObsRelay:
    ...
    def _read_flags(self, transcript_path: str) -> list[str]:
        """回退读 FLAG 候选文件(读法单源:redpilot_worker.roster.read_flag_lines)。"""
