...
from tsecbench_contracts.text import ASSISTANT_PREVIEW_MAX, ERROR_HEAD_MAX, head_text, tail_text
from tsecbench_contracts.vocabulary import FLUSH_KINDS, LIVE_EVENT_KINDS
...
log = logging.getLogger("tsecbench_worker.orchestration")
    ...
    for i in range(CLOSE_RETRIES):
        try:
            ...
            if i + 1 < CLOSE_RETRIES:
                await _async_sleep(min(2.0 * (i + 1), 6.0))
