...
截断常量/文本工具/脱敏摘要/原子 IO 单源 tsecbench_contracts(redact/text/fsio),
...
from tsecbench_contracts.fsio import atomic_write_json, ensure_dir
from tsecbench_contracts.redact import summarize_args
from tsecbench_contracts.text import head_text, tail_text
