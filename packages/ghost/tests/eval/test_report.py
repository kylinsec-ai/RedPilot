...
判据报告(`ghost.eval.graders`)由并行任务实现,本文件**不 import 它** —— 跨任务的
...
from ghost.eval.report import RunRecord, cost, pass_k, summary, trigger_rate
from ghost.eval.store import DEFAULT_DB_PATH, EvalStore
...
def test_summary_sorts_by_execution_time_not_caller_order():
    ...
    """
    from ghost.eval.report import RunRecord, summary
