...
`skills/` 的定位走 `ghost_contracts.paths.skills_root`,不数层数:本仓已被
...
import pytest
from ghost.eval.dataset import CATEGORIES, CHECK_IDS, TaskCard, coverage, load_tasks, task_from_dict
